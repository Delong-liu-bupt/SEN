...
def get_args():
    parser = argparse.ArgumentParser(description="SEN Args")
    ######################## general settings ########################
    ...
    parser.add_argument("--distributed", default=False, help='distributed train')
    ...
    ######################## loss settings ########################
    parser.add_argument("--loss_names", default='sdm+id+mlm', help="which loss to use ['mlm', 'cmpm', 'id', 'itc', 'sdm' , 'mae']")
    parser.add_argument("--mlm_loss_weight", type=float, default=1.0, help="mlm loss weight")
    parser.add_argument("--id_loss_weight", type=float, default=1.0, help="id loss weight")
    parser.add_argument("--mae_loss_weight", type=float, default=1.0, help="mae loss weight")
    parser.add_argument("--fuse_loss_weight", type=float, default=1.0, help="fuse loss weight")
    parser.add_argument("--tri_loss_weight", type=float, default=1.0, help="tri loss weight")
    ...
    parser.add_argument("--sampler", default="idrannum", help="choose sampler from [idtentity, random, idrannum]")
